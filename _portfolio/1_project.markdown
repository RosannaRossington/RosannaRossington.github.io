...
<div class="img_row">
  <img class="col one" src="{{ site.baseurl }}/img/portfolio/Project1a.png" alt="" title="levels"/>
</div>
...
<div class="img_row">
  <img class="col one" src="{{ site.baseurl }}/img/portfolio/Project1_levels.png" alt="" title="levels"/>
</div>
<div class="col three caption">
